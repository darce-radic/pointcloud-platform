...
# Webhook URLs are configured via N8N_PAYMENT_FAILED_WEBHOOK / N8N_NEW_USER_WEBHOOK env vars
N8N_PAYMENT_FAILED_WEBHOOK = settings.N8N_PAYMENT_FAILED_WEBHOOK
