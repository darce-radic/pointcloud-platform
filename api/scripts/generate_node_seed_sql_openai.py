"""
Generate SQL seed file for workflow_node_schemas using real OpenAI embeddings.
Produces supabase/seeds/003_node_library.sql with text-embedding-3-small vectors.

Usage:
    OPENAI_API_KEY=sk-... python api/scripts/generate_node_seed_sql_openai.py
"""
...
NODE_LIBRARY = [
    ...
    },
    {
        ...
        "category": "io",
        "description": "Export detected features or classified point cloud segments as a GeoJSON FeatureCollection and upload to R2/S3. The GeoJSON can be loaded directly into QGIS, Mapbox, Leaflet, or any standard GIS tool. Use as the final output node when the goal is a 2D map layer.",
...
def main():
    ...
    lines = [
        f"-- Auto-generated by api/scripts/generate_node_seed_sql_openai.py",
        f"-- Model: {EMBEDDING_MODEL} (dim={EMBEDDING_DIM})",
        f"-- Run in the Supabase SQL editor or via: supabase db push",
        "",
